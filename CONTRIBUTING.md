...
* To declare a bug, or ask for an improvement, create an [*issue*] (https://github.com/hadrilec/geoapyfr/issues)
* To contribute code or documentation directly, you can use a [*Pull Request*] (https://github.com/hadrilec/geoapyfr/pulls). In this case, it is best to link it to an *issue*.
